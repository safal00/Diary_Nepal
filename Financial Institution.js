...
const SHEET_GID = "545153698"; // Replace with the specific tab GID
...
console.log("💰 Financial Institutions directory script loaded");
...
fetch(url)
  ...
  .then(text => {
    ...
    .filter(r => r["Province"] || r["District"] || r["Local"] || r["Office Name"] || r["Phone"]);

    console.log(`✅ Loaded ${allRows.length} financial institutions`);
    initFilters();
    applyFilters();
  })
  .catch(err => console.error("❌ Error loading financial institutions sheet:", err));
