// ------------------ Google Sheet info ------------------
const SHEET_ID = "1wXNfEA5Hqnw3pnMduzDZajEMXkTCBRizQLIiLSsk1yI"; // Replace with your Google Sheet ID
const SHEET_GID = "2110244878"; // Replace with the specific tab GID
...
console.log("🏛️ Government Institutions directory script loaded");
...
fetch(url)
  ...
  .then(text => {
    ...
    .filter(r => r["Province"] || r["District"] || r["Local"] || r["Government Body"] || r["Office Name"] || r["Phone"]);

    console.log(`✅ Loaded ${allRows.length} government offices`);
    initFilters();
    applyFilters();
  })
  .catch(err => console.error("❌ Error loading government sheet:", err));
